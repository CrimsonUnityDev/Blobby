...
namespace Hypertonic.GridPlacement
{
    ...
    public class GridSettings : ScriptableObject
    {
        ...
        [Tooltip("This determins if you wish for the grid to change the object's materials to use placeable/unplaceable materials when in placeing the item")]
        public bool ChangeObjectMaterials = true;
